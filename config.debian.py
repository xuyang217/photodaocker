# 照片库路径（你自己的相册目录）- 修改为 Linux 风格路径
IMAGE_DIR = "/path/to/your/photos"  # 例如: "/home/user/Pictures" 或 "/mnt/photos"
...
# 自定义字体路径（为空则退回默认字体）
# 在 Debian 12 系统上，推荐使用以下中文字体路径之一：
# FONT_PATH = "/usr/share/fonts/truetype/noto/NotoSansCJK-Regular.ttc"  # Noto CJK 字体
# FONT_PATH = "/usr/share/fonts/truetype/wqy/wqy-microhei.ttc"         # 文泉驿微米黑
# FONT_PATH = "/usr/share/fonts/truetype/dejavu/DejaVuSans.ttf"         # DejaVu 字体
# FONT_PATH = "/usr/share/fonts/truetype/arphic/gkai00mp.ttf"           # AR PL KaitiM GB 楷体
# 如果留空，程序将自动查找系统中文字体（优先查找楷体）
FONT_PATH = ""
